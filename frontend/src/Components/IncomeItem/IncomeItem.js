...
const IncomeItemStyled = styled.div`
  ...
  .icon {
    ...
    height: 80px;
    border-radius: 20px;
    background: #242b30; /* Darker background for icon */
    display: flex;
    align-items: center;
    justify-content: center;
    border: 2px solid #333; /* Dark border for icon */

    i {
      font-size: 2.6rem;
      color: #42AD00; /* Illuminant green color */
    }
  }
  ...
  .content {
    ...
    h5 {
      ...
      &::before {
        ...
        height: 0.8rem;
        border-radius: 50%;
        background: ${props => props.indicator}; /* Maintain indicator color */
      }
    }
